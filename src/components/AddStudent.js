...
import Typography from '@mui/material/Typography';
  ...
  //adding student
  addStudent = () => { //arrow function, similar format as in schedulelist.js
    ...
    handleChange1 = (e) => {
	   ...
	   this.setState({student: temp}) //set the name
    }

	handleChange2 = (e) => {
       var temp2 = this.state.student;
	   temp2.email = e.target.value;
	   this.setState({student: temp2}) //set the email
    }
...
export default AddStudent; //so it can be imported, can have only 1
  
  
//line 87 note: onclick should be a reference to a method, do not call method
//was onClick={this.addStudent(this.state.student)}
//was addstudent(student) ....